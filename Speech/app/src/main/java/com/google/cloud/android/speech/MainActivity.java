    ...
    private final VoiceRecorder.Callback mVoiceCallback = new VoiceRecorder.Callback() {
        ...
        public void onVoice(byte[] data, int size) {
            if (mSpeechService != null) {
                ...
                if(mVoiceRecorder.runSpeakerVertification()){
                    speakerVertification.recognition(mVoiceRecorder.getRecordingBuffer());
                }
            }
        }
        ...
        public void onVoiceEnd() {
            showStatus(false);
            if (mSpeechService != null) {
                isVertified = speakerVertification.isVertified(); // = true : set backgroud
                if(isVertified)
                    System.out.println("Vertified");
    ...
    private static class ResultAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if(isVertified){
                ...
                System.out.println("Vertified #ffffff");
